...
namespace RedBlackBSTExample
{
    class RedBlackBST<Key,Value>:IEnumerable where Key:IComparable
    {
    ...
    private Node root;     // root of the BST
        ...
        private class Node
        {
            ...
            public bool color;     // color of parent link, RED is TRUE, BLACK is FALSE
   ...
   ***************************************************************************/
        ...
        {
            if (isEmpty()) throw new ArgumentException("BST underflow");
  ...
  ***************************************************************************/
   ...
   ***************************************************************************/
        ...
        */
        ...
        {
            return null;// NotImplementedException;
        }
    }
}
